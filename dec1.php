...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>EduNation Decorations - Michael Harrison</title>
...
<div id="topbar">
	...
	<div class="container_12">
		<div id="content">
			...
			<div id="home">
				<div class="grid_12">
				<p><a href="home.php">Home</a> &gt; <a href="catalog.php">Products</a> &gt; <a class="current" href="decor.php">Decorations</a></p>
				...
				<div class="grid_4 suffix_1">
					<div id="item">
						<h1>Adhesive Letters</h1>
						<h2>Pacon Corporation</h2>
						<img src="img/item9.jpg" alt="Adhesive Letters" />
					</div>
				</div>
				<div class="grid_3">
					<div id="itemright">
						...
						<p>Easy to use - just peel and place! A unique adhesive makes these fade-resistant letters removable, repositionable and reusable. Adheres to any clean, dry surface that is smooth or lightly textured. Set includes uppercase letters with numbers and punctuation marks.</p>
