...
(1510002, 'Little Ladybug', 'Trend Enterprises', 'Fun designs make a big impact anywhere! Coordinate with bulletin board sets and use as calendar markers, flash cards, game pieces, and mini awards to make learning fun. Precut and ready-to-use. About 3" tall; 36 per pack', 'Good Behavior', 'Recognition', 'Focus', 3, 1000, 1.05, 2.75, 'item24.png'),
