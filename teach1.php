...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>EduNation Teacher Aids - Michael Harrison</title>
...
<div id="topbar">
	...
	<div class="container_12">
		<div id="content">
			...
			<div id="home">
				<div class="grid_12">
				<p><a href="home.php">Home</a> &gt; <a href="catalog.php">Products</a> &gt; <a class="current" href="teach.php">Teacher Aids</a></p>
				...
				<div class="grid_4 suffix_1">
					<div id="item">
						<h1>Shelf Organizer</h1>
						<h2>Pacon Corporation</h2>
						<img src="img/item10.jpg" alt="Shelf Organizer" />
					</div>
				</div>
				<div class="grid_3">
					<div id="itemright">
						...
						<p>Designed to handle the weight of heavier materials like reams of paper and books. The shelves measure 12-1/2" x 10" x 3". Easy to assemble.</p>
